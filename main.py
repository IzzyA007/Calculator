...
"""The math part of the calculator / the back end of the calculator"""
...
"""This is the button section the second part"""

Button(root,text="C", width=5, height=1, font=("arial",30,"bold"), bd=1,fg= "#fff",bg="#3697f5", command=lambda: clear()).place(x=10,y=100)  #This is the clear button#
...
Button(root,text="=", width=11,height=1, font=("arial",30,"bold"), bd=1,fg= "#fff",bg="#fe9037", command=lambda: calculate()).place(x=430,y=400)
